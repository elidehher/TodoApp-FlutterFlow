...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginPassowordTextController ??= TextEditingController();
    _model.loginPassowordFocusNode ??= FocusNode();
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.loginPassowordTextController,
                                      focusNode: _model.loginPassowordFocusNode,
                                      autofocus: false,
                                      textInputAction: TextInputAction.done,
                                      obscureText:
                                          !_model.loginPassowordVisibility,
                                      decoration: InputDecoration(
                                        isDense: true,
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          final user = await authManager.signInWithEmail(
                            ...
                            _model.loginPassowordTextController.text,
                          );
                          if (user == null) {
                            return;
                          }
