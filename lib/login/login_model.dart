...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for Login-Passoword widget.
  FocusNode? loginPassowordFocusNode;
  TextEditingController? loginPassowordTextController;
  ...
  void initState(BuildContext context) {
    ...
    loginPassowordVisibility = false;
  }
  ...
  void dispose() {
    ...
    loginPassowordFocusNode?.dispose();
    loginPassowordTextController?.dispose();
  }
}
